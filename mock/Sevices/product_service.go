...
// Source: ./Sevices/product_service.go
...
func (m *MockProductServiceInterface) GetNewProductById(id int) (Models.Product, int) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNewProductById", id)
	ret0, _ := ret[0].(Models.Product)
	ret1, _ := ret[1].(int)
	return ret0, ret1
}
...
func (mr *MockProductServiceInterfaceMockRecorder) GetNewProductById(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNewProductById", reflect.TypeOf((*MockProductServiceInterface)(nil).GetNewProductById), id)
}
